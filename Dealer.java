...
class Dealer{
    ...
    Dealer(SHinterface sh, Image cardspic, Graphics g, Hand hand, Image back, Image backSW, boolean fastgame, boolean seven, boolean nine, boolean swap, Image[] pointer,Image burntPic, Score score)
    {
        this.sh = sh;
    ...
    *--------------------------------------------*/
    ...
    {
    String command = "otherdetails:" + otherNames[1] + ":" + hands[1].getFaceUp(0).getNumber() + ":" + hands[1].getFaceUp(1).getNumber() + ":"
                + hands[1].getFaceUp(2).getNumber() + ":" + otherNames[2] + ":" + + hands[2].getFaceUp(0).getNumber() + ":"
                + hands[2].getFaceUp(1).getNumber() + ":" + hands[2].getFaceUp(2).getNumber() + ":" + playersName + ":"
                + hands[3].getFaceUp(0).getNumber() + ":" + + hands[3].getFaceUp(1).getNumber() + ":" + hands[3].getFaceUp(2).getNumber() + ":";
    sendCommand(command, 0);


    command = "otherdetails:" + otherNames[2] + ":" + hands[2].getFaceUp(0).getNumber() + ":" + hands[2].getFaceUp(1).getNumber() + ":"
                + hands[2].getFaceUp(2).getNumber() + ":" + playersName + ":" + + hands[3].getFaceUp(0).getNumber() + ":"
                + hands[3].getFaceUp(1).getNumber() + ":" + hands[3].getFaceUp(2).getNumber() + ":" + otherNames[0] + ":"
                + hands[0].getFaceUp(0).getNumber() + ":" + + hands[0].getFaceUp(1).getNumber() + ":" + hands[0].getFaceUp(2).getNumber() + ":";
    sendCommand(command, 1);


    command = "otherdetails:" + playersName + ":" + hands[3].getFaceUp(0).getNumber() + ":" + hands[3].getFaceUp(1).getNumber() + ":"
                + hands[3].getFaceUp(2).getNumber() + ":" + otherNames[0] + ":" + + hands[0].getFaceUp(0).getNumber() + ":"
                + hands[0].getFaceUp(1).getNumber() + ":" + hands[0].getFaceUp(2).getNumber() + ":" + otherNames[1] + ":"
                + hands[1].getFaceUp(0).getNumber() + ":" + + hands[1].getFaceUp(1).getNumber() + ":" + hands[1].getFaceUp(2).getNumber() + ":";
    ...
    g.drawImage(pointer[whosturn], (int)pointerpoints[whosturn].getX(), (int)pointerpoints[whosturn].getY(), sh);
    if(sh.smallscreen())
        sh.scalepic();
    sh.repaint();
    }
    ...
    if(hands[3].getCard(0) == null){//if player only has cards on table
        if(hands[3].getFaceUp(0) != null || hands[3].getFaceUp(1) != null || hands[3].getFaceUp(2) != null){ // if cards still faceup on table
            ...
            if(isValidCard(card, command)){
                ...
                if(hands[3].getFaceDown(0) == null && hands[3].getFaceDown(1) == null && hands[3].getFaceDown(2) == null)
                    outofgame(3);
            }else{//player must pick up the deck if not valid
                sh.addMsg("The card you played was a " + hands[3].getFaceDown(cardno).getStringValue() + " you had to pick up the pile");
                hands[3].addCard(hands[3].getFaceDown(cardno));
                for(int n = 0; n < 3; n++)
                    sendCommand("othersturn:" + playersName +":facedown:pickup:" + hands[3].getFaceDown(cardno).getNumber() + ":", n);
                for(int n = 0; n < 52; n++){
                    if(pile[n] == null)
                        break;
        ...
        //checking if player is out of the game
        if(hands[3].getFaceDown(0) == null && hands[3].getFaceDown(1) == null && hands[3].getFaceDown(2) == null && hands[3].getCard(0) == null){
            outofgame(3);
            if(whosturn == 3)
                nextTurn();
        }
        ...
        if(card.getValue() == 9 && nine == true){
            ...
            if(pile[count] != null){
                ...
                //do nothing as valid card
                    ...
                    if(card.getValue() >= 7)
                        return false;
                }else if(!(card.getValue() == 2 || card.getValue() == 10 || card.getValue() >= pile[count].getValue()))
                    return false;
            }
        }else if(seven == true && pile[0].getValue() == 7){
            if(card.getValue() >= 7)
                return false;        
        }else if(!(card.getValue() == 2 || card.getValue() == 10 || card.getValue() >= pile[0].getValue()))
            return false;
    }
    ...
    if(numbertoplay <= 1)
        return false;
    String command = "othersturn:" + playersName +":faceup:multi:" + numbertoplay + ":" + card.getNumber() + ":";
    addcardtopile(card);
    numbertoplay--;
    for(int n = 0; n < 3; n++)
        if(hands[3].getFaceUp(n) != null){
            if(numbertoplay <= 0)
                break;
            if(card.getValue() == hands[3].getFaceUp(n).getValue() && card.getNumber() != hands[3].getFaceUp(n).getNumber()){
    ...
    if(numbertoplay <= 1)
        return false;
    String command = "othersturn:" + playersName + ":multi:" + numbertoplay + ":" + card.getNumber() + ":";
    addcardtopile(card);
    numbertoplay--;
    ...
    for(int n = 0; n < hands[3].length() - 1; n++){
        ...
        if(numbertoplay <= 0)
            break;
        if(card.getValue() == hands[3].getCard(n).getValue() && card.getNumber() != hands[3].getCard(n).getNumber()){
    ...
    if(card.getValue() == 2){//2 can be played at anytime
        ...
        return true;
    }else if(card.getValue() == 10 || fourOfAKind(card)){//pile is burn and its players turn again
        burnt = true;
        for(int n = 0; n < 51; n++)
            pile[n] = null;
    ...
    if(variable.equals("pickup")){//if other player picks up deck
        ...
        }catch(NumberFormatException b){ sh.addMsg("processTurn - variable to Int error: " + b); }
        ...
        for(int n = 0; n < 3; n++){
            if(hands[whosturn].getFaceUp(n) != null)
                if(hands[whosturn].getFaceUp(n).getNumber() == cardNo){
                    if(hands[whosturn].getFaceUp(n).getValue() == 10 || fourOfAKind(hands[whosturn].getFaceUp(n)) == true){//if card is 10 burning the deck
                        burnt = true;
                        for(int i = 0; i < 52; i++)
                            pile[i] = null;
                        burn = true;
        ...
        if(cardno.equals("pickup")){//card that was played facedown made player pick up the deck
            ...
            }catch(NumberFormatException b){ sh.addMsg("processTurn facedown pickup- variable to Int error: " + b); }
            for(int n = 0; n < 3; n++)
                if(hands[whosturn].getFaceDown(n) != null)
                    if(hands[whosturn].getFaceDown(n).getNumber() == cardNo){
                        ...
                        for(int i = 0; i < 3; i++)
                            if(i != whosturn)
                                sendCommand("othersturn:" + otherNames[whosturn] + ":facedown:pickup:" + cardNo + ":", i);
                        sh.addMsg(otherNames[whosturn] + " played a " + Card.getCardStringValue(cardNo) + " and had to pick up the deck");
            ...
            for(int n = 0; n < 3; n++){
                if(hands[whosturn].getFaceDown(n) != null)
                    if(hands[whosturn].getFaceDown(n).getNumber() == cardNo){
                        if(hands[whosturn].getFaceDown(n).getValue() == 10 || fourOfAKind(hands[whosturn].getFaceDown(n)) == true){//if card is 10 burning the deck
                            burnt = true;
                            for(int i = 0; i < 52; i++)
                                pile[i] = null;
            ...
            if(hands[whosturn].getFaceDown(0) == null && hands[whosturn].getFaceDown(1) == null && hands[whosturn].getFaceDown(2) == null && hands[whosturn].getCard(0) == null)
                outofgame(whosturn);
        }
        ...
        }catch(NumberFormatException b){ sh.addMsg("processTurn - multi - variable to Int error: " + b); }
        ...
        for(int n = 0; n < hands[whosturn].length() - 1; n++){
            ...
            if(hands[whosturn].getCard(n).getNumber() == cardno){
                if(hands[whosturn].getCard(n).getValue() == 10 || fourOfAKind(hands[whosturn].getCard(n)) == true){//if card is 10 burning the deck
                    burnt = true;
                    for(int i = 0; i < 52; i++)
                        pile[i] = null;
                    burn = true;
    ...
    if(pile[0] != null)
    {
            ...
            if(hands[3].isFaceUp())//if player has faceup card on the table
            {
                for(int n = 0; n < 3; n++){
                    if(hands[3].getFaceUp(n) != null){
                        ...
                        if(canplay)
                            break;
                        if (seven == true && pile[top].getValue() == 7 && hands[3].getFaceUp(n).getValue() < 7){
                            canplay = true;
                            break;
                        }else if(hands[3].getFaceUp(n).getValue() == 2 || hands[3].getFaceUp(n).getValue() == 10){
                            canplay = true;
                            break;
        ...
        if(canplay){
            ...
            sh.addMsg("The card played was a " + pile[top].getStringValue() + " you had to pick up the pile");
            for(int n = 0; n < 52; n++){
                if(pile[n] == null)
                    break;
                hands[3].addCard(pile[n]);
    ...
    private void processSwap(String otherplayermsg, int commandlength, int playerNumber)
    {
        ...
        for(int n = 0; n < 3; n++){
            ...
            try{
                cardno = Integer.parseInt(cardnoString);
            }catch(NumberFormatException b){ sh.addMsg("processSwap - error - variable to Int error: " + b); }
...
class WaitforMsg implements Runnable{
    ...
    sh.addMsg("Player " + otherNames[socketNumber] + " Game Socket Has Disconnected \nReplacing player with GameAI");
    sendMsg("Player " + otherNames[socketNumber] + " Game Socket Has Disconnected Replacing player with GameAI");
    }
...
class ListenThread implements Runnable{
    ...
    public void run()
    {
        ...
        try {
            ...
            //sh.addMsg("Error Accept " + e2);//removing error notice as apears when game is started early
            endlook = true;
        }
...
class AIThread implements Runnable{
    ...
    ait.sleep(aipause);
    }catch (Exception e){ sh.addMsg("AI thead sleep error " + e);}
