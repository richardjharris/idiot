...
class SHinterface extends JFrame implements ActionListener, MouseMotionListener, MouseListener, WindowListener {
   ...
   public void actionPerformed(ActionEvent event){
        ...
        addMsg("One Play Option");
            ...
            if(playersName != "cancel#*#")
            {
                ...
                dealer = new Dealer(this, cardspic, g, hand, back, backSW, dealerD.fastgame(), dealerD.seven(), dealerD.nine(), dealerD.swap(), pointer, burntPic, score);
        ...
        try{
            Runtime.getRuntime().exec("cmd.exe /c start iexplore http://home.pacific.net.au/~cavenagh/SH/rules.html");
        }catch(Exception e){ addMsg("Error launching Internet Explorer.  Please visit http://home.pacific.net.au/~cavenagh/SH/rules.html");}
        }

        else if(label.equals("Home Page")){
        try{
            Runtime.getRuntime().exec("cmd.exe /c start iexplore http://home.pacific.net.au/~cavenagh");
        }catch(Exception e){ addMsg("Error launching Internet Explorer.  Please visit http://home.pacific.net.au/~cavenagh");}
        }
        ...
        if(dealer != null){
            ...
            if(!(playersName == "cancel" || servername == "cancel" || playersName.equals("") || servername.equals(""))){
   ...
   public void closeConnection()
   {
    ...
    //current.setRect(current.getX(), current.getY()  + scrollunitinc, current.getWidth(), current.getHeight());
